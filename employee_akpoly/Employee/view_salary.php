                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"><span class="text-muted text-xs block"><?php echo $fullname;  ?> <b class="caret"></b></span> </span> </a>
...
echo "<th scope='col'>Date Worked</th>";
echo "<th scope='col'>Hours Worked </th>";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>". $row['date_worked']. "</td>";
    echo "<td>". $row['hours_worked']. "</td>";
    $salary = $row['hours_worked'] * 20000; // calculate salary
    $total_salary += $salary; // add to total salary
    echo "<td>". number_format($salary). " VND</td>";
    echo "<td>". number_format($total_salary). " VND</td>";
    $total_salary += $row['total_salary']; // add to total salary
}

echo "</tbody>";
echo "</table>";

echo "Total Salary: ". number_format($total_salary). " VND";
